...
const VIDEASY_SERVERS: readonly VideasyServer[] = [
    ...
    {
        name: 'cuevana',
        url: `${streamSetting('STREAM_CORE_VIDEASY_API2_BASE_URL')}/cuevana/sources-with-title`,
        language: 'english'
    },
    {
        name: 'mb-flix',
        url: `${streamSetting('STREAM_CORE_VIDEASY_BASE_URL')}/mb-flix/sources-with-title`,
        language: 'english'
    },
    {
        name: '1movies',
        url: `${streamSetting('STREAM_CORE_VIDEASY_BASE_URL')}/1movies/sources-with-title`,
        language: 'english'
    },
    {
        name: 'cdn',
        url: `${streamSetting('STREAM_CORE_VIDEASY_BASE_URL')}/cdn/sources-with-title`,
        language: 'english'
    },
    {
        name: 'superflix',
        url: `${streamSetting('STREAM_CORE_VIDEASY_BASE_URL')}/superflix/sources-with-title`,
        language: 'english'
    },
    {
        name: 'lamovie',
        url: `${streamSetting('STREAM_CORE_VIDEASY_BASE_URL')}/lamovie/sources-with-title`,
        language: 'english'
    }
] as const;
...
export class VideasyProvider extends BaseProvider {
    ...
    readonly BASE_URL = streamSetting('STREAM_CORE_VIDEASY_BASE_URL');
    readonly HEADERS = {
        'User-Agent':
            'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36',
        Accept: 'application/json, */*; q=0.01',
        Referer: `${streamSetting('STREAM_CORE_VIDEASY_PLAYER_URL')}/`,
        Origin: streamSetting('STREAM_CORE_VIDEASY_PLAYER_URL')
    };
