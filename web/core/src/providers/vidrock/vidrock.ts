...
const PROXY_PREFIX = streamSetting('STREAM_CORE_VIDROCK_PROXY_PREFIX');

export class VidRockProvider extends BaseProvider {
    readonly id = 'vidrock';
    readonly name = 'VidRock';
    readonly enabled = true;
    readonly BASE_URL = streamSetting('STREAM_CORE_VIDROCK_BASE_URL');
    readonly SUB_BASE_URL = streamSetting('STREAM_CORE_VIDROCK_SUB_BASE_URL');
    readonly HEADERS = {
        'User-Agent':
                    ...
                    secondData.forEach((obj) => {
                        ...
                        sources.push({
                            url: this.createProxyUrl(finalUrl, {
                                ...this.HEADERS,
                                Referer: `${streamSetting('STREAM_CORE_VIDROCK_DECRYPT_ORIGIN')}/`,
                                Origin: `${streamSetting('STREAM_CORE_VIDROCK_DECRYPT_ORIGIN')}/`
                            }),
