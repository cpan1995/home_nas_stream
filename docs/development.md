...
Detailed implementation notes and historical verification results, retained from
the original README. For the current overview and setup, start with the
[project README](../README.md). Device observations below are specific to the
recorded environment and are not a compatibility guarantee.
