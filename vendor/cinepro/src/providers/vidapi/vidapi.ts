...
export class VidApiProvider extends BaseProvider {
    ...
    readonly BASE_URL = streamSetting('STREAM_CORE_VIDAPI_BASE_URL');
    readonly IFRAME_URL = streamSetting('STREAM_CORE_VIDAPI_IFRAME_URL');
    readonly API_URL = streamSetting('STREAM_CORE_VIDAPI_API_URL');
    readonly HEADERS = {
        'User-Agent':
