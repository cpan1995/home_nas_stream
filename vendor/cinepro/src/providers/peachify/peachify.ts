...
export class PeachifyProvider extends BaseProvider {
    ...
    readonly BASE_URL = streamSetting('STREAM_CORE_PEACHIFY_BASE_URL');
    readonly MOVIEBOX_URL = streamSetting('STREAM_CORE_PEACHIFY_MOVIEBOX_URL');
    readonly API_URL = streamSetting('STREAM_CORE_PEACHIFY_API_URL');
    readonly HEADERS = {
        'User-Agent': '',
